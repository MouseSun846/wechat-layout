...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
  ...
  if (request.action === 'convertMarkdown') {
    ...
    // 转换 Markdown 为 HTML
    convertMarkdownToHTML(markdownText, theme, font).then(html => {
      // 将 HTML 插入到微信公众号编辑器中
...
async function convertMarkdownToHTML(markdown, theme, font) {
  ...
  if (!marked) {
    try {
      const markedModule = await import(chrome.runtime.getURL('node_modules/marked/marked.min.js'));
  ...
  let output = marked(markdown, { renderer: WxRenderer });

  // 附加脚注
  // NOTE: The original code had a custom renderer `wxRenderer` that handled footnotes.
  // This simplified version doesn't have that, so we're skipping footnotes for now.
...
async function processMermaidCharts(html) {
  ...
  mermaidBlocks.forEach((block, index) => {
    ...
    // Ensure element has the correct class name for rendering
  ...
  // Use Promise to wait for mermaid rendering to complete
...
// CSS content from md2wechat/src/assets/css/themes.css
...
.themes.chengxin .footnote-word {
  color: #ff3502;
}
.themes.chengxin .footnote-ref {
  color: #ef7060;
}
.themes.chengxin p code,
.themes.chengxin i code {
  color: #ef7060;
}
.themes.mohei {
  /* Block Elements */
...
.themes.chazi .footnote-word {
  color: #773098;
}
.themes.chazi .footnote-ref {
  color: #773098;
}
.themes.chazi strong {
  color: #773098;
...
.themes.nenqing blockquote:before {
  content: "“";
  display: inline;
  color: #555555;
  font-size: 4em;
...
.themes.nenqing blockquote p {
  display: inline;
}
.themes.nenqing a {
  color: #47c1a8;
  border-bottom: 1px solid #47c1a8;
}
.themes.nenqing .footnote-word {
  color: #47c1a8;
}
.themes.nenqing .footnote-ref {
  color: #47c1a8;
}
.themes.nenqing strong {
  color: #47c1a8;
}
.themes.nenqing em {
  color: #47c1a8;
}
.themes.nenqing p code,
.themes.nenqing li code {
  color: #47c1a8;
}
.themes.nenqing .footnote-item em {
  color: black;
}
.themes.lvyi {
  font-size: 15px;
...
.themes.lvyi .footnote-word {
  color: #35b378;
}
.themes.lvyi .footnote-ref {
  color: #35b378;
}
.themes.lvyi strong {
  color: #35b378;
...
.themes.hongfei h2 .content {
  font-family: STHeitiSC-Light;
  font-size: 18px;
  font-weight: bolder;
  display: inline-block;
  padding-left: 10px;
  border-left: 5px solid #f83929;
}
.themes.hongfei h3 .content {
  font-size: 14px;
  color: #a5d55d;
}
.themes.hongfei ul {
...
.themes.hongfei blockquote:before {
  content: " ";
  display: inline;
  color: #fff;
  font-size: 4em;
...
.themes.hongfei blockquote.important p {
  color: #feeeed;
  font-size: 13px;
  display: inline;
}
.themes.hongfei blockquote.important:after {
  content: "”";
  float: right;
  display: inline;
  color: #fff;
...
.themes.hongfei .footnote-word {
  color: #f83929;
}
.themes.hongfei .footnote-ref {
  color: #f83929;
}
.themes.hongfei strong {
  font-weight: border;
  color: #f83929;
}
.themes.hongfei em {
...
.themes.hongfei figcaption {
  display: block;
  font-size: 12px;
  font-family: PingFangSC-Light;
}
.themes.hongfei p code,
.themes.hongfei li code {
  color: #ff5d6c;
}
.themes.hongfei table tr th,
.themes.hongfei table tr td {
  font-size: 14px;
}
.themes.hongfei .footnote-item em {
  color: #6e1e51;
  font-size: 12px;
}
.themes.wechat-format p {
  line-height: 1.6;
  color: #3f3f3f;
  font-size: 16px;
  margin: 10px 0px;
}
.themes.wechat-format h2 {
...
.themes.wechat-format blockquote {
  color: #5b5b5b;
...
.themes.wechat-format blockquote.important p {
  color: #3f3f3f;
  line-height: 1.5;
  font-size: 16px;
  margin: 10px;
...
.themes.wechat-format a {
  color: #ff3502;
  border-bottom: 1px solid #ff3502;
}
.themes.wechat-format .footnote-word {
  color: #ff3502;
  font-size: 16px;
  line-height: 1.5;
  font-weight: normal;
}
.themes.wechat-format .footnote-ref {
  color: #ff3502;
  font-weight: normal;
}
.themes.wechat-format strong {
  color: #ff3502;
  line-height: 1.5;
  font-size: 16px;
}
.themes.wechat-format p code,
.themes.wechat-format li code {
  background: #f8f5ec;
  color: #ff3502;
  line-height: 1.5;
  font-size: 90%;
...
.themes.lanying blockquote.impotant {
  background: #f9f9f9;
  border-left-color: hsl(216, 100%, 68%);
}
.themes.lanying blockquote.impotant p {
  color: #999;
  padding: 3px 0;
}
.themes.lanying a {
...
.themes.lanying .footnote-word,
.themes.lanying .footnote-ref {
  font-weight: normal;
  color: hsl(187, 100%, 45%);
}
.themes.lanying strong {
  color: hsl(216, 80%, 44%);
}
.themes.lanying del {
  color: #999;
...
.themes.lanying p,
.themes.lanying li,
.themes.lanying li span,
.themes.lanying h4,
.themes.lanying table tr td {
  color: #666;
}
.themes.lanying table tr th {
  color: #333;
  font-weight: normal;
}
.themes.lanying p code,
.themes.lanying li code {
  color: hsl(216, 100%, 68%);
}
.themes.lanying sup {
  line-height: 0;
}
.themes.lanying .footnote-item p {
  color: #666;
}
.themes.lanying .footnote-item p em {
  color: #999;
...
.themes.kejilan h3 .content {
  font-size: 18px;
  color: #0e88eb;
}
.themes.kejilan blockquote.important {
  font-style: normal;
  border-left: none;
  padding: 10px;
  position: relative;
...
.themes.kejilan blockquote.important:before {
  content: "★ ";
  display: inline;
  color: #0e88eb;
  font-size: 4em;
...
.themes.kejilan blockquote.important p {
  color: #0e88eb;
  font-size: 15px;
  display: inline;
}
.themes.kejilan blockquote.important:after {
  content: "”";
  float: right;
  display: inline;
  color: #0e88eb;
...
.themes.kejilan .footnote-word {
  color: #0e88eb;
}
.themes.kejilan .footnote-ref {
  color: #0e88eb;
}
.themes.kejilan strong {
  font-weight: border;
  color: #0e88eb;
}
.themes.kejilan em {
...
.themes.kejilan figcaption {
  display: block;
  font-size: 12px;
  font-family: PingFangSC-Light;
}
.themes.kejilan table tr th,
.themes.kejilan table tr td {
  font-size: 15px;
}
.themes.kejilan .footnote-item em {
  color: #082a71;
  font-size: 12px;
}
.themes.lanqing p {
...
.themes.lanqing .footnote-word {
  color: #009688;
}
.themes.lanqing .footnote-ref {
  color: #009688;
}
.themes.lanqing hr {
  margin: 20px 0;
}
.themes.lanqing p code,
.themes.lanqing li code {
  color: #009688;
}
.themes.lanqing table tr th {
  border: 1px solid #009688;
  background-color: #009688;
  color: #f8f8f8;
  border-bottom: 0;
}
.themes.lanqing table tr td {
  border: 1px solid #009688;
}
.themes.lanqing table tr:nth-child(2n) {
...
.themes.shanchui blockquote {
  border-left-color: #ffb11b;
  background: #fff5e3;
}
.themes.shanchui blockquote p {
  color: #595959;
}
.themes.shanchui a {
  border: none;
...
.themes.shanchui figcaption {
  color: #dda52d;
  font-size: 14px;
}
.themes.shanchui p code,
.themes.shanchui li code {
  color: #9b6e23;
  background-color: #fff5e3;
  padding: 3px;
  margin: 3px;
}
.themes.shanchui table tr th,
.themes.shanchui table tr td {
  text-align: center;
}
.themes.shanchui .footnote-word {
  color: #ffb11b;
  padding: 3px;
}
.themes.shanchui .footnote-ref {
  color: #dda52d;
  margin: 2px;
  padding: 3px;
}
...
.themes.qianduan h1 {
  text-align: center;
  background-image: url(https://yanxi123.com/md2wechat/assets/images/mountain_2.webp);
...
.themes.qianduan h3:before {
  content: "";
  background-image: url(https://yanxi123.com/md2wechat/assets/images/mountain_1.webp);
...
.themes.qianduan blockquote.important {
  padding: 15px 20px;
  line-height: 27px;
...
.themes.qianduan blockquote.important p {
  padding: 0px;
  font-size: 15px;
  color: #595959;
}
...
.themes.qianduan figcaption {
  display: block;
  font-size: 12px;
  font-family: PingFangSC-Light;
}
.themes.qianduan p code,
.themes.qianduan li code {
  color: #3c70c6;
}
.themes.qianduan table tr th,
.themes.qianduan table tr td {
  font-size: 14px;
}
.themes.qianduan .footnotes {
  padding-top: 8px;
}
.themes.qianduan .footnote-word {
  color: #3c70c6;
}
.themes.qianduan .footnote-ref {
  color: #3c70c6;
}
.themes.qianduan .footnote-item em {
  color: #3c70c6;
  font-size: 13px;
  font-style: normal;
  border-bottom-color: 1px dashed #3c70c6;
}
.themes.qianduan .footnote-num {
  color: #3c70c6;
}
.themes.qianduan .footnote-item p {
  color: #3c70c6;
  font-weight: bold;
}
.themes.qianduan .footnote-item a {
  color: #3c70c6;
}
.themes.qianduan .footnote-item p em {
  font-size: 14px;
  font-weight: normal;
...
.themes.jikehei blockquote.important {
...
.themes.jikehei blockquote.important p {
  font-size: 15px;
...
.themes.jikehei p code,
.themes.jikehei li code {
  color: #ef7060;
}
.themes.jikehei .footnote-word {
  color: #ff3502;
}
.themes.jikehei .footnote-ref {
  color: #ef7060;
}
.themes.jian {
  font-size: 16px;
...
.themes.jian .footnote-word,
.themes.jian .footnote-ref {
  color: #004a7c;
}
.themes.jian .footnote-item em {
  color: #004a7c;
}
.themes.jian p,
.themes.jian section,
...
.themes.jian blockquote.important {
  background: none;
  border-left: 4px solid #ddd;
  padding: 0 1em;
}
.themes.jian blockquote.important p {
  margin: 0;
  color: #666;
}
.themes.jian strong {
...
.themes.jian pre code {
  font-size: 0.875em;
}
.themes.jian figure img {
  max-width: 100%;
  width: auto;
  margin: 0 auto;
}
.themes.jian table tr th,
.themes.jian table tr td {
  font-size: 1em;
}
.themes.jian .footnote-item {
  margin: 0.4em 0;
}
.themes.jian .footnote-item * {
  line-height: 1.4 !important;
}
.themes.jian .footnote-item p {
  margin: 0;
  font-size: 0.9em;
}
.themes.jian .footnote-item em {
...
.themes.jian .footnote-item span {
  flex: 0 0 1.5em;
  margin-right: 10px;
  font-size: 0.9em;
}
.themes.jian pre.code-snippet__js {
  padding: 16px 0;
}
.themes.jian pre.code-snippet__js code {
  font-size: 14px;
}
.themes.jian .code-snippet__fix .code-snippet__line-index {
  counter-reset: line;
  flex-shrink: 0;
  height: 100%;
  padding: 1em;
...
.themes.qiangweizi h1 {
  font-size: 25px;
}
.themes.qiangweizi h1 .content {
  display: inline-block;
  font-weight: bold;
  color: #595959;
}
.themes.qiangweizi h2 {
  text-align: left;
  margin: 20px 10px 0px 0px;
}
.themes.qiangweizi h2 .content {
  font-size: 18px;
  font-weight: bold;
  display: inline-block;
  padding-left: 10px;
...
.themes.qiangweizi h3 {
  font-size: 16px;
  font-weight: bold;
  text-align: center;
}
.themes.qiangweizi h3 .content {
  border-bottom: 2px solid #dec6fb;
  color: #595959;
}
.themes.qiangweizi blockquote {
...
.themes.qiangweizi blockquote::before {
  content: "❝";
  /*   color: #d9b8fa;*/
  color: #dec6fb;
  font-size: 34px;
...
.themes.qiangweizi blockquote p {
  color: #595959;
}
.themes.qiangweizi blockquote::after {
  content: "❞";
  float: right;
  /*   color: #d9b8fa; */
  color: #dec6fb;
...
.themes.qiangweizi strong {
  color: #595959;
  font-weight: bold;
}
.themes.qiangweizi strong::before {
  content: "「";
}
.themes.qiangweizi strong::after {
  content: "」";
}
.themes.qiangweizi em {
  font-style: normal;
  color: #595959;
  background: #f6eeff;
}
.themes.qiangweizi del {
  color: #595959;
}
.themes.qiangweizi hr {
  height: 1px;
  padding: 0;
  border: none;
  border-top: 2px solid #d9b8fa;
}
.themes.qiangweizi img {
  border-radius: 6px;
  display: block;
  margin: 20px auto;
  object-fit: contain;
}
.themes.qiangweizi figcaption {
  display: block;
  font-size: 13px;
  color: #595959;
}
.themes.qiangweizi p code,
.themes.qiangweizi li code {
  color: #595959;
}
.themes.qiangweizi .code-snippet__fix {
  background: #f7f7f7;
  border-radius: 2px;
}
.themes.qiangweizi table tr th,
.themes.qiangweizi table tr td {
  font-size: 14px;
  color: #595959;
}
.themes.qiangweizi .footnotes {
  background: #f6eeff;
...
.themes.qiangweizi .footnote-word {
  font-weight: normal;
  color: #595959;
}
.themes.qiangweizi .footnote-ref {
  font-weight: normal;
  color: #595959;
}
.themes.qiangweizi .footnote-item em {
  background: #f6eeff;
  font-size: 14px;
  color: #595959;
  display: block;
}
.themes.qiangweizi .footnote-item p {
  color: #595959;
  font-weight: bold;
}
.themes.qiangweizi .footnote-item p em {
  font-weight: normal;
}
.themes.menglv {
  line-height: 1.6;
...
.themes.menglv blockquote.important {
  padding: 15px 20px;
  line-height: 27px;
...
.themes.menglv blockquote.important p {
  padding: 0px;
  font-size: 15px;
  color: #595959;
}
...
.themes.menglv figcaption {
  display: block;
  font-size: 12px;
  font-family: PingFangSC-Light;
}
.themes.menglv p code,
.themes.menglv li code {
  color: #28ca71;
}
.themes.menglv table tr th,
.themes.menglv table tr td {
  font-size: 14px;
}
.themes.menglv .footnotes {
  padding-top: 8px;
}
.themes.menglv .footnote-word {
  color: #5ab983;
}
.themes.menglv .footnote-ref {
  color: #5ab983;
}
.themes.menglv .footnote-item em {
  color: #5ab983;
  font-size: 13px;
  font-style: normal;
  border-bottom-color: 1px dashed #5ab983;
}
.themes.menglv .footnote-num {
  color: #5ab983;
}
.themes.menglv .footnote-item p {
  color: #5ab983;
  font-weight: bold;
}
.themes.menglv .footnote-item a {
  color: #5dba85;
}
.themes.menglv .footnote-item p em {
  font-weight: normal;
  font-style: normal;
}
.themes.quanzhanlan {
...
.themes.quanzhanlan h1 {
  font-size: 25px;
}
.themes.quanzhanlan h1 span {
  display: inline-block;
  font-weight: bold;
  color: #40b8fa;
}
.themes.quanzhanlan h2 {
  display: block;
  border-bottom: 4px solid #40b8fa;
}
.themes.quanzhanlan h2 .prefix {
  display: flex;
  width: 20px;
  height: 20px;
  background-size: 20px 20px;
...
.themes.quanzhanlan h2 .content {
  display: flex;
  color: #40b8fa;
  font-size: 20px;
  margin-left: 25px;
}
.themes.quanzhanlan h2 .suffix {
  display: flex;
  box-sizing: border-box;
  width: 200px;
  height: 10px;
...
.themes.quanzhanlan h3 .content {
  border-bottom: 2px solid rgba(79, 177, 249, 0.65);
  color: #2b2b2b;
  padding-bottom: 2px;
}
.themes.quanzhanlan h3 .content:before {
  content: "";
  width: 30px;
  height: 30px;
  display: block;
...
.themes.quanzhanlan h4 .content {
  height: 16px;
  line-height: 16px;
  font-size: 16px;
}
.themes.quanzhanlan h4 .content:before {
  content: "";
...
.themes.quanzhanlan blockquote.important {
  text-size-adjust: 100%;
  line-height: 1.55em;
  font-weight: 400;
  border-radius: 6px;
...
.themes.quanzhanlan blockquote.important::before {
  content: "❝";
...
.themes.quanzhanlan blockquote.important p {
  color: #595959;
}
.themes.quanzhanlan blockquote.important::after {
  content: "❞";
  float: right;
  color: rgba(64, 184, 250, 0.5);
}
.themes.quanzhanlan a {
  color: #40b8fa;
  font-weight: normal;
  border-bottom: 1px solid #3baafa;
}
.themes.quanzhanlan strong {
  color: #3594f7;
  font-weight: bold;
}
.themes.quanzhanlan strong::before {
  content: "「";
}
.themes.quanzhanlan strong::after {
  content: "」";
}
.themes.quanzhanlan em {
  color: #3594f7;
  font-weight: bold;
}
.themes.quanzhanlan del {
  color: #3594f7;
}
.themes.quanzhanlan hr {
  height: 1px;
  padding: 0;
  border: none;
  border-top: 2px solid #3baafa;
}
.themes.quanzhanlan img {
  border-radius: 6px;
  display: block;
  margin: 20px auto;
  object-fit: contain;
...
.themes.quanzhanlan figcaption {
  display: block;
  font-size: 13px;
  color: #2b2b2b;
}
.themes.quanzhanlan figcaption:before {
  content: "";
  background-image: url(https://yanxi123.com/md2wechat/assets/images/arrow-32-32.png);
  display: inline-block;
  width: 18px;
  height: 18px;
...
.themes.quanzhanlan p code,
.themes.quanzhanlan li code {
  color: #3594f7;
...
.themes.quanzhanlan .code-snippet__fix {
  background: #f7f7f7;
  border-radius: 2px;
}
.themes.quanzhanlan pre code {
  letter-spacing: 0px;
}
.themes.quanzhanlan table tr th,
.themes.quanzhanlan table tr td {
  font-size: 14px;
  color: #595959;
}
.themes.quanzhanlan .footnotes {
  background: #f6eeff;
  padding: 20px 20px 20px 20px;
  font-size: 14px;
  border: 0.8px solid #dec6fb;
...
.themes.quanzhanlan .footnote-word {
  font-weight: normal;
  color: #595959;
}
.themes.quanzhanlan .footnote-ref {
  font-weight: normal;
  color: #595959;
}
.themes.quanzhanlan .footnote-item em {
  font-size: 14px;
  color: #595959;
  display: block;
}
...
.themes.quanzhanlan .footnote-item p {
  color: #595959;
  font-weight: bold;
}
.themes.quanzhanlan .footnote-item p em {
  font-weight: normal;
  font-style: normal;
}
.themes p {
...
.themes .footnote-item {
  display: flex;
}
.themes .footnote-item .footnote-num {
  display: inline;
  flex: 1;
  background: none;
  font-size: 80%;
